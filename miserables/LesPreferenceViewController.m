        ...
        case 0:
            if (indexPath.row == 2) {
                ...
                if (!self.nav.downloadOperation) {
                    NSURLRequest *req = [NSURLRequest requestWithURL:[NSURL URLWithString:@"http://42.121.18.11/static/mis/article.db"] cachePolicy:NSURLRequestUseProtocolCachePolicy timeoutInterval:15.0];
